...
CopyrightPass (CRP) is a digital tool token designed for IP licensing, PLR/PPR rights verification, DAO governance, and Merkle Tree asset records.

---

## Official Documents

- CopyrightPass CRP Litepaper v3.0 EN
- CopyrightPass CRP Litepaper v3.0 CN
- BNB Smart Chain contract addresses
- Token information
- Protocol documentation
- City Pass ecosystem references

---

## Official Websites

- CopyrightPass: https://copyrightpass.org
...
| Contract | Address |
|---|---|
| CRP Token | `0x2059b3cdb31abaeBc9E313246795b754F8A2784c` |
...
The official CRP Litepaper is available on the CopyrightPass website:

- English: https://copyrightpass.org/docs/CopyrightPass_CRP_Litepaper_v3.0_EN.pdf
- Chinese: https://copyrightpass.org/docs/CopyrightPass_CRP_Litepaper_v3.0_CN.pdf
